<div class="flex justify-center items-center space-x-4">
    <a href="mailto:info@ksdinteriors.cz" class="mb-2 inline-block rounded-2xl px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transform hover:scale-105" style="background-color: #000000">
      <div class="flex items-center"> <!-- Přidáno obalový div -->
        ...
        <span class="ml-2">Odeslat email</span> <!-- Přidáno nápis tlačítka -->
      </div>
    </a>

    <a href="instagram.com/truhlarstvi_ksdinteriors" class="mb-2 inline-block rounded-2xl px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transform hover:scale-105" style="background-color: #000000">
        <div class="flex items-center"> <!-- Přidáno obalový div -->
            <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-4 w-4"
          ...
          <span class="ml-2">Instagram</span> <!-- Přidáno nápis tlačítka -->
        </div>
      </a>
