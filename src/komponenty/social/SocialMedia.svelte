<div class="flex justify-center items-center space-x-2">
    ...
    <a href="instagram.com/truhlarstvi_ksdinteriorss" class="mb-2 inline-block rounded-2xl px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transform hover:scale-105" style="background-color: #000000">
        <div class="flex items-center"> <!-- Přidáno obalový div -->
